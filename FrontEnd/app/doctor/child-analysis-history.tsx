...
const childrenData: Record<string, ChildOverviewData> = {
  Lily: {
    name: "Lily",
    childId: "#1045",
    age: 5,
    ...
    monitoringTitle: "Needs Monitoring",
    monitoringLevel: "Moderate Anxiety Risk",
    monitoringDescription: "Requires Continued Observation",
  },
  ...
  Sammy: {
    ...
    monitoringTitle: "Needs Monitoring",
    monitoringLevel: "Moderate Emotional Risk",
    monitoringDescription: "Requires Continued Observation",
  },
};
...
export default function ChildOverviewScreen() {
  ...
  const childParam = getParamValue(params.child);
  const childIdParam = getParamValue(params.childId);

  const child =
    childParam && childrenData[childParam]
      ? childrenData[childParam]
      : childrenData.Lily;

  const displayChildId = childIdParam || child.childId;
  ...
  const handleViewAll = () => {
    Alert.alert(
      "Analysis Timeline",
      "The full analysis timeline will be connected later."
    );
  };
        ...
        >
          ...
          <View style={styles.currentStatusCard}>
            <View style={styles.currentStatusHeader}>
              ...
              <View style={styles.currentStatusBadge}>
                ...
                <Text
                  style={styles.currentStatusBadgeText}
                >
                  {child.status}
                </Text>
              </View>
          ...
          <View style={styles.sectionCard}>
            <View style={styles.sectionCardHeader}>
              ...
              <Text style={styles.sectionSideText}>
                4 Week Timeline
              </Text>
            </View>
          ...
          <View style={styles.timelineContainer}>
            {child.analysisTimeline.map((item) => (
              <TouchableOpacity
              ...
              >
                ...
                <View style={styles.analysisTextContainer}>
                  <Text style={styles.analysisEmotion}>
                    {item.emotion}
                  </Text>
          ...
          >
            ...
            <View style={styles.recommendationTimeline}>
          ...
          <View style={styles.monitoringCard}>
            ...
            <Text style={styles.monitoringLevel}>
...
function EmotionProgress({
  ...
  return (
    <View style={styles.emotionProgressItem}>
      <View style={styles.emotionProgressHeader}>
